...
urlpatterns = [
    ...
    path('messages/notifications/', views.notifications, name='notifications'),
    
    path('messages/notifications/<int:notification_id>/viewed/', views.viewed_notification, name='viewed_notification'),
